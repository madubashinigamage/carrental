...
<?php $sql = "SELECT tblvehicles.VehiclesTitle,tbltype.BrandName,tblvehicles.PricePerDay,tblvehicles.FuelType,tblvehicles.ModelYear,tblvehicles.id from tblvehicles join tbltype on tbltype.id=tblvehicles.VehiclesBrand";
$query = $dbh -> prepare($sql);
$query->execute();
